 ...
 */
final class Version20200624144202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE medecin (id INT AUTO_INCREMENT NOT NULL, soin_id INT NOT NULL, nil VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, INDEX IDX_1BDA53C66F952169 (soin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
